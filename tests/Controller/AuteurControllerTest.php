...
final class AuteurControllerTest extends WebTestCase
{
    ...
    private string $path = '/admin/auteur/';
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'auteur[biographie]' => 'Testing',
            'auteur[naissance]' => 'Testing',
            'auteur[deces]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'auteur[biographie]' => 'Something New',
            'auteur[naissance]' => 'Something New',
            'auteur[deces]' => 'Something New',
        ]);

        self::assertResponseRedirects('/admin/auteur/');
        ...
        self::assertSame('Something New', $fixture[0]->getDeces());
    }
